---
name: 5-maid-qa-ship
description: MAID Phase 5 - QA and Release. Use for validating implementations, acceptance tests, preparing releases, deployment, operational readiness.
---
...
> **Note:** Git push and final release happen in Phase 6 (User Feedback), after the user approves the build.
> This phase certifies the code is *ready to ship* — it does not ship.
